  ...
  "ix-fyzikalni-terapie:1": {
    chapters: [
      ...
      },
      {
        ...
        points: [
          ...
          "2. Střídavý",
          "- směr a velikost proudu se v čase mění (katoda a anoda se rychle mění)",
    ...
    flashcards: [
      ...
      },
      {
        ...
        answer: "tok elektricky nabitých částic (ionty - kationt/aniont nebo elektrony - záporně nabité částice ), dobře prochází tkáněmi s velkým obsahem vody a bílkovin - největší odpor průchodu klade kůže, kost, chrupavka, šlacha (malý obsah vody) - směr od katody (mínus) k anodě (plus), jednotka Ampér - účinek - analgetický, trofický, antiedematózní, myostimulační 1. Stejnosměrný - jednosměrný tok, anoda a katoda na stejném místě (nemění se) - galvanizace - ionický účinek",
      },
      {
      ...
      },
      {
        ...
        prompt: "Co je důležité k bodu: - směr a velikost proudu se v čase mění (katoda a anoda se rychle mění)?",
        answer: "- směr a velikost proudu se v čase mění (katoda a anoda se rychle mění)",
      },
      {
    ...
    quizQuestions: [
      ...
      },
      {
        ...
        correctOptionIndexes: [0],
        explanation: "- směr a velikost proudu se v čase mění (katoda a anoda se rychle mění)",
      },
      {
  ...
  "ix-fyzikalni-terapie:2": {
    ...
    flashcards: [
      ...
      },
      {
        ...
        answer: "1. Transregionálně (příčná) - elektrony umístěné na opačné strany postižené oblasti, proud prochází napříč oblasti - distorze, kontuze - do 24-36h po úrazu 2. Podélná galvanizace - entezopatie, funkční porucha prokrvení (akrocyanóza, Raynaudův syndrom)..",
      },
      {
        id: "ix-fyzikalni-terapie:2:flashcard:18",
        prompt: "Co je důležité k bodu: Transregionálně (příčná)?",
        answer: "1. Transregionálně (příčná)",
      },
      {
        id: "ix-fyzikalni-terapie:2:flashcard:19",
        prompt: "Co je důležité k bodu: - elektrony umístěné na opačné strany postižené oblasti, proud prochází napříč oblasti?",
        answer: "- elektrony umístěné na opačné strany postižené oblasti, proud prochází napříč oblasti",
      },
      {
        id: "ix-fyzikalni-terapie:2:flashcard:20",
        prompt: "Co je důležité k bodu: - distorze, kontuze?",
        answer: "- distorze, kontuze",
      },
      {
        id: "ix-fyzikalni-terapie:2:flashcard:21",
        prompt: "Co je důležité k bodu: - do 24-36h po úrazu?",
        answer: "- do 24-36h po úrazu",
      },
      {
        id: "ix-fyzikalni-terapie:2:flashcard:22",
        prompt: "Co je důležité k bodu: Podélná galvanizace?",
        answer: "2. Podélná galvanizace",
      },
      {
        id: "ix-fyzikalni-terapie:2:flashcard:23",
        prompt: "Co je důležité k bodu: - entezopatie, funkční porucha prokrvení (akrocyanóza, Raynaudův syndrom)..?",
        answer: "- entezopatie, funkční porucha prokrvení (akrocyanóza, Raynaudův syndrom)..",
      },
      {
        id: "ix-fyzikalni-terapie:2:flashcard:24",
        prompt: "Co je důležité k bodu: - elektrody jsou umístěné za sebou podél končetiny/jiné části těla, proud prochází podélně?",
        answer: "- elektrody jsou umístěné za sebou podél končetiny/jiné části těla, proud prochází podélně",
      },
    ],
    quizQuestions: [
      {
  ...
  "ix-fyzikalni-terapie:5": {
    ...
    quizQuestions: [
      ...
      },
      {
        ...
        correctOptionIndexes: [0],
        explanation: "1. Dvoupolová interference (modulace je vytvořena v přístroji, jednodušší aplikace",
      },
      {
        ...
        correctOptionIndexes: [0],
        explanation: "- jednookruhové bipolární aplikace (lze i na akutní stavy), čtyřlístek se mění na přímku",
      },
      {
  ...
  "ix-fyzikalni-terapie:6": {
    ...
    flashcards: [
      ...
      },
      {
        ...
        prompt: "Co je důležité k bodu: - destrukce jader se zvýšenou mitotickou aktivitou, desintegrace, nekroza, zvýší se difuz...?",
      ...
      },
      {
        ...
        prompt: "Co je důležité k bodu: - porucha vodivosti nervů, zvýší se enkefaliny, porucha tvorby kapilár, snížena obranysch...?",
      ...
      },
      {
        ...
        prompt: "Shrň část: Indikace",
        answer: "1. posttraumatické stavy - kontuze, distorze, fraktury (po 48 hod) - snížení otoku, bolesti, podpora hojení 2. revmatoidní artritidy, artrózy - m. Bechtěrev, bursitis, capsulitis, tendinitis 3. onemocnění periferních nervů - neuropatie, Fantomové bolesti 4. poruchy cirkulace - Raynaud, KRBS (pouze segmentální aplikace)",
      },
      {
        id: "ix-fyzikalni-terapie:6:flashcard:23",
        prompt: "Co je důležité k bodu: posttraumatické stavy?",
        answer: "1. posttraumatické stavy",
      },
      {
        id: "ix-fyzikalni-terapie:6:flashcard:24",
        prompt: "Co je důležité k bodu: - kontuze, distorze, fraktury (po 48 hod)?",
        answer: "- kontuze, distorze, fraktury (po 48 hod)",
      },
    ],
    quizQuestions: [
      {
      ...
      },
      {
        ...
        correctOptionIndexes: [0],
        explanation: "- kontuze, distorze, fraktury (po 48 hod)",
      },
      {
        ...
        correctOptionIndexes: [0],
        explanation: "- snížení otoku, bolesti, podpora hojení",
      },
    ],
  },
  ...
  "ix-fyzikalni-terapie:9": {
    chapters: [
      ...
      },
      {
        ...
        points: [
          ...
          "- energie = J = W(síla) .s (čas), hustota energie J/cm2",
    ...
    flashcards: [
      ...
      },
      {
        ...
        answer: "klimatoterapi, vliv na růst, regeneraci, psychický vliv 1. Biolampa - polychromatické (více vlnových délek), polarizované světlo, nonkoherentní (vlny nejsou synchronizované) - biostimulace, dodání energie, stimuluje syntézu kolagenu - indikace: hojení ran, popáleniny, kožních defektů - minimální účinek na poruchy pohybového ústrojí, nemá vliv na hlubší partie",
      },
      {
      ...
      },
      {
        ...
        prompt: "Co je důležité k bodu: - polychromatické (více vlnových délek), polarizované světlo, nonkoherentní (vlny nejsou ...?",
        answer: "- polychromatické (více vlnových délek), polarizované světlo, nonkoherentní (vlny nejsou synchronizované)",
      },
    ],
    quizQuestions: [
      {
      ...
      },
      {
        ...
        correctOptionIndexes: [0],
        explanation: "- léčba psoriáza, dermatózy, seborea",
      },
      {
  ...
  "ix-fyzikalni-terapie:12": {
    ...
    flashcards: [
      ...
      },
      {
        ...
        prompt: "Shrň část: Dělení",
        answer: "1. zevní 2. vnitřní - kloktání/výplach nosu, inhalace, pitné kůry, irrigace dásní 1. prosté - použitá pouze voda, neupravená, bez přísad 2. s přírodní minerální vodou - jako přírodní léčivý zdroj, bez technických přídavných pomůcek a neupravovaná 1. klidové nebo s využitím techniky (vířivé, perličkové, masážní, protiproudy v bazéně..) 2. voda s uměle přidanými přísady (organické",
      },
      {
      ...
      },
      {
        ...
        answer: "3. hypertermní 38-42°C",
      },
      {
        id: "ix-fyzikalni-terapie:12:flashcard:22",
        prompt: "Co je důležité k bodu: - 42°C bod tolerance pro celkovou vodní koupel (nevhodná pro cvičení)?",
        answer: "- 42°C bod tolerance pro celkovou vodní koupel (nevhodná pro cvičení)",
      },
      {
        id: "ix-fyzikalni-terapie:12:flashcard:23",
        prompt: "Co je důležité k bodu: - 46°C bod tolerance pro kůži pro částečné koupele (od kolen/loktů distálně)?",
        answer: "- 46°C bod tolerance pro kůži pro částečné koupele (od kolen/loktů distálně)",
      },
      {
  ...
  "ix-fyzikalni-terapie:13": {
    ...
    flashcards: [
      ...
      },
      {
        ...
        prompt: "Co je důležité k bodu: - např. aktivace oslabených svalů (stimuluje širší oblast a je méně selektivní než klasic...?",
    ...
    quizQuestions: [
      ...
      },
      {
        ...
        correctOptionIndexes: [0],
        explanation: "- nevyvolává svalovou kontrakci, používá se hlavně kvůli biologickým účinkům",
      },
      {
      ...
      },
      {
        ...
        correctOptionIndexes: [0],
        explanation: "3. Vysokointenzivní pulzní magnetické pole",
      },
      {
        ...
        correctOptionIndexes: [0],
        explanation: "- vysoká magnetická indukce aktivuje nervy a svaly, analgetický efekt",
      },
      {
        ...
        correctOptionIndexes: [0],
        explanation: "- např. aktivace oslabených svalů (stimuluje širší oblast a je méně selektivní než klasická elektrostimulace)",
      },
      {
  ...
  "ix-fyzikalni-terapie:14": {
    chapters: [
      ...
      },
      {
        ...
        points: [
          ...
          "2. periferních kloubů",
          "- součást manuální terapie a mobilizace",
    ...
    flashcards: [
      ...
      },
      {
        ...
        prompt: "Co je důležité k bodu: - fáze eliminace?",
        answer: "- fáze eliminace: končetina bledne",
      },
      {
        id: "ix-fyzikalni-terapie:14:flashcard:15",
        prompt: "Co je důležité k bodu: - působení na končetinu zevním tlakem?",
        answer: "- působení na končetinu zevním tlakem",
      },
      {
        id: "ix-fyzikalni-terapie:14:flashcard:16",
        prompt: "Co je důležité k bodu: - nejčastěji se používá IPC intermitentní pneumatická komprese?",
        answer: "- nejčastěji se používá IPC intermitentní pneumatická komprese",
      },
      {
        id: "ix-fyzikalni-terapie:14:flashcard:17",
        prompt: "Co je důležité k bodu: - končetina vložena do návleku s několika komory, které se postupně nafukují a dochází k ...?",
        answer: "- končetina vložena do návleku s několika komory, které se postupně nafukují a dochází k rytmické kompresi končetiny",
      },
      {
        id: "ix-fyzikalni-terapie:14:flashcard:18",
        prompt: "Co je důležité k bodu: - tlak je aplikovaný z distálního směru proximálně?",
        answer: "- tlak je aplikovaný z distálního směru proximálně",
      },
      {
        id: "ix-fyzikalni-terapie:14:flashcard:19",
        prompt: "Co je důležité k bodu: - účinky?",
        answer: "- účinky: podpora venózního návratu, lymfatického toku, redukce otoku, zlepšení cirkulace",
      },
      {
    ...
    quizQuestions: [
      ...
      },
      {
        ...
        correctOptionIndexes: [0],
        explanation: "- působení na končetinu zevním tlakem",
      },
      {
        ...
        correctOptionIndexes: [0],
        explanation: "- nejčastěji se používá IPC intermitentní pneumatická komprese",
      },
      {
        ...
        correctOptionIndexes: [0],
        explanation: "- končetina vložena do návleku s několika komory, které se postupně nafukují a dochází k rytmické kompresi končetiny",
      },
      {
        ...
        correctOptionIndexes: [0],
        explanation: "- tlak je aplikovaný z distálního směru proximálně",
      },
    ],
  },
  "ix-fyzikalni-terapie:15": {
    ...
    flashcards: [
      ...
      },
      {
        ...
        prompt: "Co je důležité k bodu: - proudění (teplo odvádí proudící medium?",
        answer: "- proudění (teplo odvádí proudící medium",
      },
      {
        id: "ix-fyzikalni-terapie:15:flashcard:17",
        prompt: "Co je důležité k bodu: - proudící vzduch, voda)?",
        answer: "- proudící vzduch, voda)",
      },
      {
      ...
      },
      {
        ...
        answer: "zvýšení prokrvení tkáně 1. aktivní hyperémie - vazodilatace arteriol a zvýšení průtoku krve vede ke zvýšení přísunu O2, živin, odvodu metabolitů, podpoře regenerace, snížení tonu - teplo využíváme před mobilizací, protahováním, cvičením, manuální terapií 2. reaktivní hyperémie - vzniká po krátkodobém přerušení nebo výrazným omezení průtoku krve 3. pasivní hyperémie",
      },
    ],
    quizQuestions: [
      {
